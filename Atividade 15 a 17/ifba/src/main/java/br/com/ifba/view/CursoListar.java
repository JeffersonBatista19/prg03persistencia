...
import br.com.ifba.config.SpringContext;
...
public class CursoListar extends javax.swing.JFrame {
    ...
    // Construtor SEM parâmetros (para o método main e NetBeans)
    public CursoListar() {
        initComponents();
        
        // Tenta obter o controller do Spring
        try {
            this.cursoController = SpringContext.getBean(CursoController.class);
        } catch (Exception e) {
            System.err.println("Spring não inicializado. Rodando sem controller.");
        }
    }
    
    public CursoListar(CursoController cursoController) {
